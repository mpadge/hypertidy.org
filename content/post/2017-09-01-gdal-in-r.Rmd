...
authors and it slowly dawned on what it meant to have a *geo-spatial data abstraction library*. To realize what this meant I had spent
...
I wonder if many of us see rgdal as the definition of the GDAL abstraction. I see pretty clearly the difference, and while the package has been extremely useful for me I've long wanted lower level control and access to the GDAL core itself. (I had extremely influential gudiance from a professional team of programmers, and I've discussed GDAL with many others, including Manifold GIS company employees and many users. I assume most R users don't know much about the details, and why would they want to). 

It's been a long time, but I've recently found a way over the key obstacle I had - building a package to compile for use in R with bindings to GDAL itself. I have a lot to thank Roger Bivand and Edzer Pebesma for many years of instruction and guidance in that, in many different ways. I also am extremely grateful to R-Core for the overall enviroment, ad to Jeroen Ooms and Mark Padgham, and there are many others. This is something I've wanted to be able to do for a really long time. I hope this post helps provide context to why, and I'm very happy to discuss the issues with anyone. 

## vapour

My response to this is `vapour`, this is my version of a *very minimal interpration* of the core GDAL facilities. There's a function to read
...
you should explore the.  `Rcpp` and the modern tools for R really do make this immensely more easy than in the past (RStudio has *intellisense* for C++ ...). 

I also believe strongly that R is well-placed to write the future of multi-dimensional and hierarchical and complex structured and geo-spatial data. We aren't looking at GIS and hoping to match them, they are, or will, be looking at R and wondering how it got so good so fast. 
